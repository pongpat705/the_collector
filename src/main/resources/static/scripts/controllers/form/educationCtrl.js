...
angular
	.module('app')
		.controller('educationCtrl', [	'$scope', '$http', '$localStorage', 
									'$timeout', '$translate', 
									'$state' , '$stateParams', 'Restangular', 
									'toastr', '$rootScope', 'formService',
  function educationCtrl($scope, $http, $localStorage, 
		  			$timeout, $translate, 
		  			$state, $stateParams, Restangular, 
		  			toastr, $rootScope, formService) {
	
	$scope.$watch("init", function(){
		$scope.formName = $rootScope.moneyControlForms.EDUCATION_SUPPORT.value1;
		$scope.getAllNbutGet();
	});
